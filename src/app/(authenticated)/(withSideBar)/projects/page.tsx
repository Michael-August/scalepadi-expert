                ...
                <div className="rounded-3xl gap-3 w-full border border-[#D1DAEC80] hide-scrollbar p-3 h-[862px] overflow-y-scroll">
                    ...
                    {activeTab === "activeProjects" &&
                        <div className="h-full flex flex-col gap-2 w-full bg-[#FBFCFC] rounded-3xl p-3 hide-scrollbar overflow-y-scroll">
                            <Link href={'/projects/1'} className="project w-full p-3 rounded-2xl flex flex-col gap-2">
                                <div className="top w-full flex items-center gap-3">
                                    ...
                                    <div className="flex flex-col gap-1">
                                        <span className="text-sm text-[#878A93] ">GreenMart Ltd</span>
                                ...
                                <div className="bg-white border border-[#D1DAEC80] flex flex-col gap-2 p-4 rounded-[14px] w-full">
                                    <span className="text-sm text-[#878A93] font-normal">Role: <span className="text-[#1A1A1A]">Sales Strategist</span></span>
                                    <div className="flex flex-col gap-2 text-sm font-normal">
                                        <span className="text-[#1A1A1A]">Project brief:</span>
                                        <span className="text-[#727374]">Theming allows users to leverage the power of the dotLottie format by adding multiple themes into a single file. This enables you can easily embed one animation file into your design project and switch between themes without the need to create multiple files.</span>
                                    </div>
                                </div>
                                <Button className="bg-primary text-white text-xs w-fit rounded-[10px] px-2 ">Open Workspace</Button>
                            </Link>

                            <Link href={'/projects/2'} className="project w-full p-3 rounded-2xl flex flex-col gap-2">
                                <div className="top w-full flex items-center gap-3">
                                    <div className="bg-[#D1F7FF] flex items-center justify-center p-[5.84px] text-[#1A1A1A] text-xs h-[54px] rounded-[11.68px]">BlueMart</div>
                                    <div className="flex flex-col gap-2">
                                        <span className="text-sm text-[#878A93] ">Growth Audit for GreenMart </span>
