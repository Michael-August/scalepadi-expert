        ...
        <div className="flex flex-col items-center justify-center gap-6 lg:w-[506px]">
          <div className="top flex flex-col gap-4 items-center justify-center">
            ...
            <span className="text-secondary-text text-base font-medium text-center">
              Choose your preferred means of signing in
            </span>
          </div>
          {signInMethod === "initial" && (
            <div className="rounded-3xl bg-white p-10 border border-[#EFF2F3] w-full flex flex-col gap-6">
              <Button
                ...
                className="bg-primary text-white py-6 flex gap-3 rounded-[14px] w-full"
              >
                <Mail />
                Sign In with Email
              </Button>
              <span className="font-medium text-center text-sm text-[#1A1A1A]">
                Or
              </span>
              <Button
                variant={"outline"}
                className="py-6 flex gap-3 rounded-[14px] w-full"
              >
                <Image
              ...
              >
                ...
                <div className="form-group flex flex-col gap-2">
                  ...
                  <Link
                    ...
                    className="font-normal text-sm text-[#878A93] cursor-pointer"
                  >
                    Forgot password
                  </Link>
                </div>
          ...
          <div className="w-full">
            <Link href={"/signup"} className="text-sm text-[#878A93] text-left">
