export const NIGERIAN_STATES_AND_LGAS: Record<string, string[]> = {
  ...
  Jigawa: [
    ...
    "Kazaure", "Kiri Kasama", "Kiyawa", "Maigatari", "Malam Madori", "Miga",
  ...
  Kano: [
    ...
    "Dawakin Tofa", "Fagge", "Garko", "Garun Mallam", "Gaya", "Gezawa", "Gwale",
    "Gwarzo", "Kabo", "Kano Municipal", "Karaye", "Kibiya", "Kiru", "Kumbotso",
    "Kunchi", "Kura", "Madobi", "Makoda", "Minjibir", "Nasarawa", "Rano",
  ...
  Rivers: [
    ...
    "Obio-Akpor", "Ogba–Egbema–Ndoni", "Ogu–Bolo", "Okrika", "Omuma",
